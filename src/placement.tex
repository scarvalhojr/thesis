...
\footnotesize{
\begin{tabular*}{\hsize}{crrld{4}d{4}rld{4}d{4}r}
\vspace{1pt}
...
\footnotesize{
\begin{tabular*}{\hsize}{crd{4}rd{4}rld{4}rd{4}r}
\vspace{1pt}
...
still exhibit a ``layered'' structure, althought the layers are much narrower
