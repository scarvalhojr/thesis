...
Embeddings & Algorithm & \multicolumn{1}{r}{ACI} & Time \\
\hline
...
Centered   & 2-DP with $L_{max}=30$ and Greedy with $Q=900$    & \nb{341}{2786} & 2.3 \\
...
\caption{\label{tab:pp_x_cq}
  ...
  the results of using PP on similar input. The relative difference between the
  two algorithms is shown in percentage.}
\footnotesize{
\begin{tabular}{ld{4}d{4}d{4}d{4}}
\vspace{1pt}
 & \multicolumn{1}{c}{$100\times 100$} & \multicolumn{1}{c}{$200\times 200$} & \multicolumn{1}{c}{$300\times 300$} & \multicolumn{1}{c}{$500\times 500$} \\ \cline{2-5}
\vspace{1pt}
 & \multicolumn{1}{r}{NBL} & \multicolumn{1}{r}{NBL} & \multicolumn{1}{r}{NBL} & \multicolumn{1}{r}{NBL} \\
\hline
CQ $D=1$ &      19.8595  &      19.1558  &      19.4735  &      19.1310  \\
PP $D=2$ & \nb{19}{7414} & \nb{18}{6572} & \nb{17}{9959} & \nb{17}{3154} \\
Relative &     -0.60$\%$ &     -2.60$\%$ &     -7.59$\%$ &     -9.49$\%$ \\
\hline
CQ $D=2$ & \nb{20}{1673} &      19.4199  &      19.0263  &      18.7480  \\
PP $D=4$ &      20.4057  & \nb{19}{1756} & \nb{18}{4533} & \nb{17}{6462} \\
Relative &     +1.18$\%$ &     -1.26$\%$ &     -3.01$\%$ &     -5.88$\%$ \\
\hline
CQ $D=3$ & \nb{20}{7378} & \nb{19}{7625} &      19.1470  &      18.6523  \\
PP $D=6$ &      21.1305  &      19.8459  & \nb{19}{0458} & \nb{18}{1701} \\
